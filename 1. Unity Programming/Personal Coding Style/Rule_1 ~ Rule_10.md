...
- [Rule\_7 : 간단한 데이터(팝업 이름 같이)가 이상하게 왔는데 코드로 수정이 되면 그냥 코드로 수정하자.](#rule_7--간단한-데이터팝업-이름-같이가-이상하게-왔는데-코드로-수정이-되면-그냥-코드로-수정하자)
...
# Rule_7 : 간단한 데이터(팝업 이름 같이)가 이상하게 왔는데 코드로 수정이 되면 그냥 코드로 수정하자.
- 핑퐁 귀찮다.
