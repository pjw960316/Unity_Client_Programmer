...
- 협업에서 가독성이 좋은 코드를 작성하는 것은 중요하다. 
  - 하지만 개인의 스타일을 확고히 하는 가장 큰 이유는 스타일에 대한 고민을 줄이는 것과 나의 과거 코드를 잘 읽기 위함이다.
  - **결국 시간 낭비를 줄일 수 있다. 즉 생산성을 높인다.**
- 선배님들의 코드를 보면서 좋은 스타일을 찾았다면 나의 스타일에 추가하자.
- '클린 코드'를 읽으면서 스타일을 챙기고, 생산성을 증대 시키자.
