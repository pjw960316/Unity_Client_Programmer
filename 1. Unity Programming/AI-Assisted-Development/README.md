...
## :white_check_mark: 3단계_GPT에게 질문하기
...
- **AI가 만든 코드에서 내가 이해가 되지 않는 부분을 찾아서 공부하기**
   ...
   - 가장 2026년에 맞는 공부 방법이라 생각한다. 예전에 게임 개발 공부하던 느낌도 나고.
...
## :white_check_mark: 4단계_CODEX에게 구현 요청하고 내가 검토하기
...
- :smile: **이제는 기존의 공부를 벗어나야 한다.**
  ...
  - 오히려 개발자라는 직업이 새롭게 전환되는 혼란기에 공부할 건 많다!
  - 좋은 설계를 해냈을 때 쾌감이 오지 않을까 기대한다.
