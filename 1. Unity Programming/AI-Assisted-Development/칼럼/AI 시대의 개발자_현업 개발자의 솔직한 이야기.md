...
- 적어도 '해줘~'형 개발자가 되진 말자. 과거에도 코드 몽키는 있었으니. 나 또한 직장에서 코드 몽키였고.

<br><br>

## test_2
![alt text](./captures/20260416_2.png)
- 어차피 이제 구현은 AI를 이길 수 없다. 하지만 오히려 검증 장치가 생긴거라 기쁘기도 하다.

<br><br>

## :fire: 뭘 알아야 AI에게 프롬프트를 넣지
![alt text](./captures/20260416_1.png)
- 수업시간에 내용을 모르면 질문조차도 할 수 없다. 
- 물론 AI는 질문도 생산해 줄 수 있지만 그 질문 자체도 모르면 의미가 없다.
- 만약 질문을 하기 위해 좀 알아본다면 그게 결국 공부고.
