...
- $\bf{\large{\color{#ff0000}As는\ 비교\ 대상의\ 인스턴스\ 타입과\ 캐스팅을\ 하려는\ 타입과\ 동일하거나\ 캐스팅을\ 하려는\ 타입의\ 하위\ 타입이면\ 캐스팅이\ 성공한다.}}$
- $\bf{\large{\color{#ff0000}obj의\ 인스턴스\ 타입은\ Pomeranian이고\ 캐스팅을\ 하려는\ 타입은\ Dog다.}}$
- obj 인스턴스 타입인 Pomeranian은 캐스팅을 하려는 타입 Dog과 동일하지는 않지만 하위 타입이므로 캐스팅에 성공한다.
<br/><br/><br/>
