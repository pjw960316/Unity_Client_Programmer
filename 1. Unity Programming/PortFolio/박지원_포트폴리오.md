...
<div style="text-align: center;">
  <img src="./captures/test.png" width="600">
</div>

- 회사에서 많이 적었지만 다시 안 봤던 경험 → 실무에서는 모든 걸 완벽히 정리하기 어렵다는 경험 → 현재는 100 → 10 → 3으로 계속 압축
- 과거 메모 / 현재 정제된 기록 비교

<div style="text-align:center; margin-top:20px;">
  <img src="./captures/3-1_notion.png"
       style="
         width:75%;
         height:250px;
         object-fit:contain;
  ...
  <div style="margin-top:8px; font-size:14px; font-weight:bold;">
    메모를 반복해서 다듬고 다시 읽기 위해 관리하고 있는 Notion 기록
  </div>
</div>
...
- 단순 개발 지식이 아니라 상황 → 선택 → 근거 → 장단점/예외를 계속 기록하고 수정
- Design Pattern README + MyCharacterManager 설계 과정
