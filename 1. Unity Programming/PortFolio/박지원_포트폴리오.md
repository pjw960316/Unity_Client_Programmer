...
- 정직원이 된 뒤 가장 어려웠던 것은 업무를 하면서도 계속 공부하고 성장하는 방법을 만드는 일이었습니다.

- 업무 중 생긴 모든 의문을 그 자리에서 깊게 공부할 수는 없었고 <br> 길게 남긴 수 많은 메모들 결국 다시 읽지 않게 되었습니다.

- 퇴사 이후에는 이 문제를 계속 고민했고, Notion과 TFT에서 얻은 경험을 바탕으로 지금은 개발 과정의 배움을 다시 제 판단 기준으로 남기는 방식을 만들고 있습니다.
...
- [여기에 이 과정을 이미지로 만들어야 해 -> 도식화로 이해되기 쉽게]

- 개발 중 Codex와 질문하고 구현하다 보면, 다시 기억하고 싶은 **핵심 키워드나 설계 기준**이 생깁니다.  
  이때 공부를 위해 개발을 멈추기보다, Codex에게 연결된 GitHub 학습 문서를 수정하도록 하고 저는 질문과 짧은 메모를 Notion에 남긴 뒤 다시 개발을 이어갑니다.

- 업무가 끝난 뒤에는 Codex가 수정한 Markdown을 그대로 저장하지 않습니다.  
  당시 Notion에 남긴 **질문 / 메모 / 제가 이해한 내용**을 다시 꺼내 Codex와 검토하고, 부족한 부분을 공부하며 문서를 다시 고칩니다.

- 결국 AI가 만든 문서는 초안이고, 반복해서 읽고 수정하며 **제가 이해한 내용을 제 언어의 기록으로 만드는 과정까지가 공부**라고 생각합니다.
...
**### :five: 기록하는 비용은 줄고, 기록의 가치는 더 커졌습니다.**

- 회사에 있을 때는 메모부터 문서 구조, Markdown 작성과 꾸미기까지 모두 직접 해야 했습니다.  
  업무가 끝난 뒤 지친 상태에서 다시 기록으로 가공하는 과정 자체가 큰 비용이었고, 결국 좋은 메모도 다시 보지 못한 채 쌓이곤 했습니다.
...
- 그리고 완성된 기록은 이제 저만 읽는 문서가 아닙니다.  
  Codex도 제가 지난 4년 동안 쌓아온 GitHub의 학습 기록과 설계 기준을 참고하며, 다음 개발에서 제가 중요하게 생각해온 방향을 함께 고려할 수 있습니다.
