...
### 2️⃣ Level_3  :  GPT를 답을 얻는 도구가 아니라, 이해를 넓히는 도구로 사용했습니다.
#### 회사 재직  /  퇴사 이후 2025년

- ![Level 3 경험 이미지](./captures/ai-level-3.png)

- 퇴사 이후에는 GPT를 본격적으로 활용해 코드가 동작하는 이유와 설계 대안, 성능·메모리 차이를 질문했습니다.
- 이전보다 훨씬 빠르게 지식을 얻을 수 있었지만, 쉽게 받은 답은 직접 구현하지 않으면 다시 제 것이 되지 않는다는 문제도 느꼈습니다.
- 그래서 답변을 그대로 복사하기보다 직접 코드를 작성하고, 비용을 확인하고, 제 언어로 설명할 수 있는지를 기준으로 학습했습니다.
- GPT는 구현을 대신하는 도구라기보다, 제가 놓친 원인과 선택지를 빠르게 드러내는 학습 도구가 되었습니다.

- ✈️[GitHub_C# 학습 기록](https://github.com/pjw960316/Unity_Client_Programmer/tree/main/1.%20Unity%20Programming/C%23%20Ver_2)

<div style="page-break-after: always;"></div>

# 🧮 [두 번째 해결과정] <br> AI 시대에 다양한 스펙트럼으로 개발?

### 3️⃣ Level_4  :  2026년 현재
#### 질문과 코드 보조를 넘어, 구현 단위를 AI에게 맡기기 시작했습니다.

- ![Level 3.5~4 경험 이미지](./captures/ai-level-4.png)
