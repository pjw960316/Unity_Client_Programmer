...
| 주제 | 이전에는 | 이제는 |
| :--- | :--- | :--- |
| 조언을 받아들이는 방식 | 사수와 리드분들께 조언을 자주 구했고<br>적극적으로 수용하려는 태도는 있었습니다.<br><br>하지만 때로는 제가 직접 해야 할 고민까지<br>조언에 의존하려는 느낌이 있었습니다. | 이제는 먼저 혼자 삽질하고 고민한 뒤<br>조언을 구하려고 합니다.<br><br>예를 들어 메서드의 추상화 레벨을<br>어디까지 올릴지 먼저 고민해보고,<br>그 고민을 바탕으로 함께 이야기하려고 합니다.<br><br>이후 조언을 제 코드와 상황에 맞게 다시 해석하고<br>선택 기준으로 만들려고 합니다. |
| 강한 피드백을 받았을 때의 대처 | 강한 피드백을 받은 뒤<br>주말까지 오래 반추했고,<br>그 감정이 다음 업무까지 이어지는 경우가 있었습니다. | 그런 주일수록 수면과 식사를 먼저 회복하고,<br>주말에는 자전거와 카페 정리를 통해<br>피드백을 다시 읽으려고 합니다.<br><br>감정이 가라앉은 뒤에는<br>다음 업무에서 바꿀 행동으로 옮기려 합니다. |
| 체력의 중요성 | 출퇴근과 업무를 버티는 체력이 부족했고,<br>체력과 건강을 업무 지속성과<br>분리해서 생각했습니다.<br><br>매일 자전거 퇴근을 계획하기도 했지만,<br>꾸준히 이어지지는 못했습니다. | 지금은 체력과 컨디션도<br>업무 지속성의 기반이라고 생각합니다.<br><br>매일 걷는 습관을 1년 이상 이어오며<br>생활 리듬을 회복했고,<br>개발과 학습을 꾸준히 지속할 수 있는<br>기반을 만들고 있습니다. |
