...
## 🛠️ 첫 번째 해결과정 &nbsp;:&nbsp; 게임의 설계에 집중하며 하나의 게임을 완성했습니다.
...
<div style="text-align: center; margin: 16px 0 8px 0;">
  <img src="./captures/0-1.png" style="
  width: 65%;
  height: auto;
  object-fit: contain;
  ">
...
- 팀에서 제게 요구했던 것은 단순히 메서드를 빠르게 생산하는 것이 아니라, <br> 기존 코드의 흐름과 기반 구조를 이해한 뒤 그 위에 기능을 올리는 일이었습니다.

<br>

- 그러나 기반 구조를 충분히 이해하지 못한 상태에서 기능 구현에만 조급해졌고, <br> 그 결과 중복 코드와 복잡한 의존성을 만들었습니다. <br> 돌이켜보면 이 문제는 인턴 시절부터 어렴풋이 알고 있었지만, 제대로 마주하지 못했던 부분이었습니다.
...
# 🔍 퇴사 이후 돌아본 네 가지 문제점
### 2️⃣ 꾸준히 실력을 쌓기보다, 조급하게 증명하려 했습니다.
<div style="text-align: center; margin: 16px 0 8px 0;">
  <img src="./captures/0-2.png" style="
    width: 65%;
    height: auto;
    object-fit: contain;
  ">
...
- 멘토님과 팀장님께 “왜 이렇게 조급하냐”는 피드백을 여러 번 들었습니다. <br>태스크를 수행할 때 기존 코드의 흐름을 깊게 파악하고 안정적으로 완성하기보다, <br>우선 돌아가게 만드는 데 급했습니다. <br>더 어려운 태스크를 맡아 1인분을 할 수 있다는 것을 증명하고 싶었습니다.

<br>

- 하지만 어려운 태스크를 맡자, 제 기본기의 빈틈이 한꺼번에 드러났습니다. <br> 하나씩 채우기보다 모두 제대로 알아야 한다는 부담에 눌려, 오히려 부족함을 피했습니다.

<br>

- 결국 저에게 필요했던 것은 거창한 계획이나 빠른 증명이 아니라, <br>채워야 할 공부를 작게 나누고 하나씩 꾸준히 쌓는 태도였습니다.

<div style="page-break-after: always;"></div>

# 🔍 퇴사 이후 돌아본 네 가지 문제점
### 3️⃣ 메모만 하고 기록으로 가공하여 제 것으로 만든 적이 적었습니다.
<div style="text-align: center; margin: 16px 0 8px 0;">
...
- 배운 내용을 적기는 했지만, 다시 읽고 설명할 수 있는 형태로 만들지 못했고, <br> 결국 지식이 제 안에 쌓이기보다 메모장 안에만 쌓였습니다.

<br>

- 이 경험을 통해 공부는 ‘적는 것’에서 끝나는 것이 아니라, <br> 다시 읽히고 설명 가능한 기록으로 가공되어야 한다는 문제의식을 갖게 되었습니다.
...
# 🔍 퇴사 이후 돌아본 네 가지 문제점
### 4️⃣ 회사에만 집중하다 보니 제 자신을 돌보지 못했습니다.
<div style="text-align: center; margin: 16px 0 8px 0;">
  <img src="./captures/0-4.png" style="
    width: 65%;
    height: auto;
    object-fit: contain;
  ">
...
- 게임 회사에 들어가는 것은 오랜 목표였고, 저는 그 목표를 비교적 이른 시기에 이뤘습니다. <br>하지만 그 이후에는 제 삶의 중심이 점점 저 자신보다 회사에 맞춰졌고, <br>잘하고 싶은 마음이 커질수록 오히려 저를 돌보는 기준은 약해졌습니다.

<br>

- 직장 생활에서 여러 번 흔들리는 순간이 있었지만, <br>그때마다 감정을 정리하고 다시 일상으로 돌아오는 방식이 부족했습니다. <br>결국 회사 생활을 지속하기 위한 체력과 정신력을 제 삶 안에서 관리하지 못했습니다.

<br>

- 퇴사 이후에는 회사에서 인정받는 방법보다, <br>제가 어떤 상태에서 꾸준히 개발하고 일할 수 있는지를 먼저 돌아보기 시작했습니다.
...
### 2️⃣ 게임 전체 구조를 Model / View / Presenter / Manager / Controller 설계로.
...
<div style="text-align: center;">
  <img src="./captures/ai-spectrum.png" width="600">
</div>
...
### 1️⃣ Level_0 ~ Level_2  :  AI가 없던 시절, 구글링과 <>로 학습을 했던 시절.

<div style="text-align: center;">
  <img src="./captures/ai-level-0-2.png" width="600">
</div>

- 넥슨게임즈에서는 클라이언트 팀 동료에게 질문하고 기존 코드의 호출 흐름을 추적하며 <br> 프로젝트 구조 안에서 직접 기능을 구현하고 문제를 해결했습니다.

- 실무에서 부족함을 느꼈던 구현 능력을 보완하기 위해 C#으로 코딩테스트를 다시 준비하고, <br> Jeffrey Richter의 『CLR via C#』을 바탕으로 언어와 런타임의 기초부터 다시 공부했습니다.

- 2026년 서술형 필기시험에서 외부 도구 없이 컴퓨터공학 지식을 직접 작성하며 <br> 과거보다 개념의 원인과 동작 과정을 깊이 설명할 수 있게 되었음을 확인했습니다.

<br>

<div style="display:flex; justify-content:center; align-items:flex-start; gap:32px;">
  <div style="width:38%; text-align:center;">
    <img src="./captures/task%20order.png" style="width:auto; height:230px; max-width:100%; object-fit:contain; border-radius:8px;">
    <div style="margin-top:8px; font-size:14px; font-weight:bold;">재직 시절 기록한 업무 우선순위</div>
  </div>
  <div style="width:38%; text-align:center;">
    <img src="./captures/boj.png" style="width:auto; height:230px; max-width:100%; object-fit:contain; border-radius:8px;">
    <div style="margin-top:8px; font-size:14px; font-weight:bold;">2026년 백준 골드 4 달성</div>
  </div>
</div>

- ✈️[GitHub_CLR via C# 학습 기록](https://github.com/pjw960316/Unity_Client_Programmer/tree/main/1.%20Unity%20Programming/C%23%20Ver_2)
...
### 2️⃣ Level_3  :  GPT와 함께 기초를 다시 공부하면서 이해를 기반으로 구현하는 개발자
#### 회사 재직  /  퇴사 이후 2025년

<div style="text-align: center;">
  <img src="./captures/ai-level-3.png" width="550">
</div>

<br>

- 회사에서는 기존 코드의 흐름을 따라 기능을 구현했지만 <br> 당시에는 코드가 동작하는 원인과 내부 비용까지 충분히 이해하지 못한 채 구현했던 경험이 있었습니다.

- 2025년에는 『CLR via C#』과 Unity 공식 문서를 GPT와 함께 공부하며 <br> 코드의 동작 원인과 설계 대안, 성능·메모리 차이까지 질문하고 이해의 빈 곳을 채웠습니다.

- 기초지식이 쌓일수록 더 구체적인 질문을 만들고 답변의 타당성을 판단할 수 있었으며 <br> 이를 직접 구현하고 검증해 작은 Unity 게임을 처음부터 끝까지 완성했습니다.

<br>

<div style="display:flex; justify-content:center; align-items:flex-start; gap:32px;">
  <div style="width:56%; text-align:center;">
    <img src="./captures/Github_README.png"
         style="width:100%; height:230px; object-fit:contain; border-radius:8px;">
    <div style="margin-top:8px; font-size:14px; font-weight:bold;">
      2023년부터 관리한 Unity 개발자 학습 기록 <br> 1,700회 이상 커밋
    </div>
  </div>

  <div style="width:32%; text-align:center;">
    <img src="./captures/Github_gameCapture.png"
         style="width:100%; height:230px; object-fit:contain; border-radius:8px;">
    <div style="margin-top:8px; font-size:14px; font-weight:bold;">
      Codex없이 직접 구현하고 완성한 <br> 1인 Unity 프로젝트
    </div>
  </div>
</div>

- ✈️[GitHub_유니티 개발자 공부](https://github.com/pjw960316/Unity_Client_Programmer)
- ✈️[GitHub_1인 유니티 프로젝트](https://github.com/pjw960316/HabitGame)

<div style="page-break-after: always;"></div>

# 🧮 [두 번째 해결과정] <br> AI와 어떻게 개발하는가

### 3️⃣ Level_4  :  질문과 코드 보조를 넘어, 구현 단위를 AI에게 맡기기 시작했습니다.
#### 2026년 현재

<div style="text-align: center;">
  <img src="./captures/ai-level-4.png" width="600">
</div>
...
### 4️⃣ 결국, AI와 함께하는 개발은 겉으로는 새로운 방식처럼 보이지만 <br> 본질적으로는 직장에서 시니어 개발자분들과 함께하던 페어 프로그래밍과 같다고 생각합니다.

<br>

<div style="text-align: center;">
  <img src="./captures/ai like mentor.png" width="700">
</div>
...
### 1️⃣ 다시 읽지 않는 메모는 제 것이 되지 않았습니다.

<div style="text-align: center;">
  <img src="./captures/3-1_overview.png" width="800">
</div>

- 돌이켜보면 회사에서 정직원이 된 뒤 가장 어려웠던 것은 <br> 업무를 하면서도 계속 공부하고 성장하는 방법을 만드는 일이었습니다.

<br>

- 업무 중 생긴 모든 의문을 그 자리에서 깊게 공부할 수는 없었고 <br> 길게 남긴 수 많은 메모들 결국 다시 읽지 않게 되었습니다.

<br>

- 퇴사 이후에는 이 문제를 계속 고민했습니다. <br> Notion과 TFT에서 얻은 경험을 바탕으로 <br> 지금은 개발 과정의 배움을 다시 제 판단 기준으로 남기는 방식을 만들고 있습니다.

<div style="page-break-after: always;"></div>

# 📚 [세 번째 해결과정] <br> 제목 아직

### 2️⃣ Notion에 기록하고, 매일 다시 보며 업데이트했습니다.

<div style="text-align:center;">
  <img src="./captures/2023 to now.png"
       style="width:800;>

  <div style="margin-top:40px; font-size:14px; font-weight:bold;">
    2023년의 메모는 첨부한 이미지보다도 훨씬 길게 적었습니다.
  </div>
</div>
...
- **2023년 ~ 2024년 회사 생활**
  - 좋은 내용을 많이 적었지만, 길어진 메모는 결국 다시 읽지 않았습니다.
  
  - 이렇게 다시 보지 않은 메모가 수백 개 쌓였습니다.
  
  - 돌아보면 당시에는 메모를 남기는 데 집중했고, 다시 읽을 수 있는 기록으로 가공하지 못했습니다.

<br>

- **현재**
  - 당시의 긴 메모를 지금 사용 중인 월간 계획표 형식으로 다시 가공했습니다.
  
  - 중요한 내용은 매일 볼 수 있는 위치에 두고 반복해서 읽습니다.
  
  - 다시 볼 때마다 고치고 줄이며, 실제로 사용할 수 있는 짧은 기록으로 정제합니다.
...
### 3️⃣ 롤토체스  :  나만의 기록을 통해 결과를 낸 사례

<div style="text-align: center;">
  <img src="./captures/TFT_and_Unity.png" width="800">
</div>

<br>

- 롤토체스를 하며 저만의 전술집을 만들었고, 게임을 할 때마다 계속 읽고 고치며 더 짧고 직관적인 기준으로 정리했습니다.

- 그 기록을 실제 판단 기준으로 사용하고, 결과를 복기해 다시 수정하는 과정을 반복하면서 상위 랭커까지 올라갔습니다.

- 이 경험을 통해 자주 보고 자주 고친 기록이 결국 나만의 판단 기준이 되고, 그것이 실력을 만든다는 것을 체감했습니다.

<div style="display:flex; justify-content:center; align-items:flex-start;">
  <div style="width:56%; text-align:center;">
    <img src="./captures/tft_rank.png"
...
### 4️⃣ Codex와 개발하며 배운 내용을 제 언어의 기록으로 남깁니다.

<div style="text-align: center;">
  <img src="./captures/3-4_study.png" width="550">
</div>

- **업무 중**
  - Codex가 AGENTS.md와 기존 GitHub 기록을 읽은 상태에서 개발하고 합니다.

  - 새로 나온 개념과 설계 기준을 공부 문서에 자동으로 추가합니다. 

  - 이 덕분에 문서를 직접 찾고 정리하는 시간이 줄어 개발 흐름을 끊지 않을 수 있습니다.

<br>

- **업무가 끝나고**
  - 업무가 끝난 뒤에는 제가 Codex가 자동으로 추가한 내용과 변경 기록만 확인합니다. 

  - 전체를 처음부터 다시 정리하지 않고 필요한 부분만 추적할 수 있어, 여기서도 복습에 드는 시간을 줄일 수 있습니다.

<br>

- **Notion과 TFT에서 배운 부분**
  - 하지만 1~3번의 자동화까지만 하면 결국 AI가 만든 기록일 뿐이라 제 공부가 되지 않았습니다. 
  
  - 가장 중요한 것은 5~6번처럼 다시 읽고 제 언어로 고쳐 판단 기준으로 만들고, <br> 그 기록을 이후의 저와 Codex가 다시 참고하는 반복 과정입니다.
...
### 5️⃣ AI 덕에 공부 절차가 단순해졌고, 그래서 공부가 이제 됨 (이런 느낌)

- 회사에 있을 때는 메모부터 문서 구조, Markdown 작성과 꾸미기까지 모두 직접 해야 했습니다.  
  업무가 끝난 뒤 지친 상태에서 다시 기록으로 가공하는 과정 자체가 큰 비용이었고, 결국 좋은 메모도 다시 보지 못한 채 쌓이곤 했습니다. (현실적 어려움.)

- codex를 통해 시간이 많이 줄어드는 내용을 강하게 적는 (끄니까 원래 오래 걸리고 복잡하니까 힘들어서 못했는데. 이젠 내가 혼자 복습할 문서를 codex가 만들어 주니까 내가 공부해야 할 시간도 줄어들고 편해지니. 오히려 하게 되는?)
  - 지금은 Codex가 기존 문서를 찾고, 초안을 작성하고, Markdown 형식을 맞추고, 필요한 내용을 기존 기록에 연결하는 작업을 도와줍니다.  
    덕분에 저는 **타이핑과 형식보다 무엇이 중요한지 판단하고, 다시 읽고, 고치고, 제 언어로 만드는 과정**에 더 많은 시간을 쓸 수 있게 되었습니다.

<br>

> 4년 동안 혼자 쌓아온 GitHub 기록을 Codex가 읽고 제 설계 기준을 참고하기 시작했을 때,  
> 그동안 계속 기록해온 시간이 헛되지 않았다는 생각이 들었습니다.

- ✈️[GitHub_나만의 디자인 패턴](https://github.com/pjw960316/Unity_Client_Programmer/tree/main/1.%20Unity%20Programming/Design%20Pattern)
...
### 1️⃣ 2024년은 살면서 처음으로 방향을 잃었고 <br> 앞으로 어떻게 살아갈지 고민했던 시기였습니다.

<div style="text-align: center;">
  <img src="./captures/mountain.jpg" width="500">
</div>

<br>

- 퇴사 시기에 실장님과 파트장님, 친척형 모두 비슷한 이야기를 해주셨습니다. <br> 다시 회사에 가기 전에 더 단단해지고, 앞으로 삶을 어떻게 살아갈지 충분히 고민해보라는 조언이었습니다.

<br>

- 퇴사 후 몇 달 동안 거의 집에서 나가지 않았습니다. <br> 혼자 있는 시간이 길어지면서 제 밑바닥을 마주했고, 오히려 어느 순간 모든 것이 담담하게 느껴졌습니다. <br> 그러던 중 친구가 불암산에 가보자고 제안했고 오랜만에 집을 나섰습니다. <br><br> 올라가는 동안 서른 번 가까이 쉬었지만, <br> 여기서 포기하면 다시 집 밖으로 나오지 못할 것 같아 끝까지 걸었고 결국 정상에 올랐습니다. <br>
그날을 계기로 다시 한번 열심히 살아보기로 했습니다. <br><br> 그리고 2년 뒤 다시 찾은 불암산은 한 번도 쉬지 않고 정상까지 올라갔습니다.

<br>

- 이후에는 바로 취업 준비를 하기보다 책을 많이 읽었습니다. <br> 건강, 운동, 마음, 삶에 대해 공부하며 앞으로 어떻게 살아갈지 제 기준부터 하나씩 정리했습니다.

<div style="page-break-after: always;"></div>

### 2️⃣ 2025년은 루틴을 하나씩 만들어갔고 <br> 제가 어떤 개발자가 되고 싶은지 알아가던 시기였습니다.
<div style="
  display: flex;
  justify-content: center;
...
">
  ...
  <div style="width: 30%; text-align: center;">
    <img src="./captures/game.png" style="
      width: 100%;
      max-height: 360px;
      object-fit: contain;
      border-radius: 8px;
    ">
    <p style="font-size: 11px; color: #666; line-height: 1.5; margin-top: 6px;">
      개발한 게임 화면
    </p>
  </div>

  <div style="width: 30%; text-align: center;">
    <img src="./captures/walk.jpg" style="
      width: 100%;
      max-height: 360px;
      object-fit: contain;
      border-radius: 8px;
  ...
  <div style="width: 30%; text-align: center;">
    <img src="./captures/2025.png" style="
      width: 100%;
      max-height: 360px;
      object-fit: contain;
      border-radius: 8px;
...
- 매일 8천 보를 걷기 시작했습니다. 그 습관은 지금도 이어지고 있으며, <br> ‘손목닥터’ 앱으로 100원씩 버는 일도 지금까지 제게 소소한 즐거움으로 남아 있습니다.
...
- 다시 개발자로 살아보려고 노력하자, 두려움도 조금씩 줄어들었습니다. <br> 주에 2번 간신히 가던 도서관도 3번, 4번으로 점점 늘어났습니다.

<br>

- 개발도 무엇부터 해야 할지 몰라 처음부터 천천히 다시 시작했습니다. <br> 한동안 손도 대지 못했던 게임 개발도 다시 이어가며, 완성 리비전을 묶게 되었습니다.

<div style="page-break-after: always;"></div>

# 🚀 [네 번째 해결과정] <br> 다시 일하기 위한 저만의 지도

### 3️⃣ 2026년은 만든 루틴을 꾸준히 실행하고 고치며 <br> 저만의 지도를 강화하고 있는 시기입니다.
<div style="margin-top: 8px; margin-left: 16px;">
  ...
  <p style="font-size: 11px; color: #666; line-height: 1.5; margin-top: 6px; text-align: center;">
    2025년 11월 ~ 2026년 1월은 이직 서류 준비, 필기 시험 준비를 병행하던 시기입니다. <br><br>
    돌아보면 이 시기에도 게임 개발을 완전히 놓지 않았어야 했습니다. <br><br>
...
- 매일 8시에 일어나 9시에 도서관에 갑니다. <br> 이제는 주중에는 하루도 빠짐없이 나가고 있습니다. 일단 나가면 뭐라도 한 가지 이상 배우게 됩니다.
...
- 이직에도 계속 도전하고 있습니다. 많이 탈락했고, 그때마다 여전히 슬프기도 합니다. <br> 하지만 이제는 맛있는 음식을 먹고, 자전거를 타고, 일찍 자면서 훌훌 털어낼 수 있게 되었습니다. <br> 예전처럼 감정에 오래 휘둘리기보다, 다시 다음 날의 루틴으로 돌아오는 힘이 생겼습니다.

<br>

- 저는 정재승 작가의 『열두 발자국』에서 말하는 “자신만의 지도”라는 표현을 좋아합니다. <br> 오늘 하기로 한 일을 꾸준히 해나가다 보면 많은 시행착오를 겪게 됩니다. <br> 그 과정에서 제가 어떤 사람인지 알아가는 시간이 생겼고, 조금씩 나아질 수 있었습니다. <br> 저는 그 시간이 저만의 지도를 그리는 과정이라고 생각합니다.
...
- 이제는 슈팅 게임을 혼자 만들 수 있습니다.

<br>

- 하지만 혼자서 할 수 있는 일에는 한계가 있고, 좋은 팀 안에서 배울 수 있는 것들이 훨씬 많습니다.
