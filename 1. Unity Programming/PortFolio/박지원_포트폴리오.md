...
### 1️⃣ Level_0 ~ Level_2  =>  AI가 없을 때 삽질해가며 개발을 해봤습니다.
#### 컴퓨터공학과 재학  /  첫 취업 준비  /  회사 재직

<div style="text-align: center;">
  <img src="./captures/ai-level-0-2.png" width="600">
</div>

- 컴퓨터공학을 전공하며 CS와 프로그래밍의 기반을 공부했습니다.
- 코딩테스트와 취업 준비를 거쳐 펄어비스 인턴과 넥슨게임즈에서 Unity 클라이언트 개발을 경험했습니다.
- 퇴사 이후에도 C# 코딩테스트를 꾸준히 풀고 GitHub에 기록하고 있습니다.
- 2026년 기업 필기 테스트에서 AI 없이 공부한 내용을 직접 적어내며, 쌓아온 지식이 제 것으로 남았음을 느꼈습니다.
