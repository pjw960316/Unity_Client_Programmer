...
# 📚 [세 번째 해결과정] <br> 적어두고 끝나는 날것의 메모를 <br> 계속 다시 보고 고치며 성장으로 이어지는 기록 시스템으로 바꾸었습니다.
...
- 결국 다시 읽히지 않는 메모는 제 것이 되지 않았습니다.

- 『거인의 노트』란 책을 읽고 나서, 메모는 남기는 것보다 가공해서 다시 읽히는 기록으로 만드는 과정이 더 중요하다는 것을 느꼈습니다.
