...
<div style="text-align: center;">
  <img src="./captures/ai-level-0-2.png" width="500">
</div>
...
<div style="text-align: center;">
  <img src="./captures/ai-level-3.png" width="600">
</div>
...
- 현재는 Rider Codex를 활용해 프로젝트 코드를 탐색하고, 여러 파일을 수정하고, 빌드까지 수행하도록 구현 단위를 맡기고 있습니다.
- 저는 구현 전에 기능의 목적, 기존 구조와의 연결 지점, 변경 가능한 범위와 완료 조건을 먼저 정리합니다.
- 이후 생성된 diff와 빌드 결과, 실제 실행 동작을 확인하며 구조를 훼손하지 않았는지와 불필요한 비용이 생기지 않았는지를 판단합니다.
- 직접 구현하던 경험과 GPT로 원인을 분석하던 경험이 있었기 때문에, AI에게 더 많은 작업을 맡기면서도 최종 결과를 제 코드로 검토할 수 있었습니다.

<div style="page-break-after: always;"></div>

# 🧮 [두 번째 해결과정] <br> AI 시대에 다양한 스펙트럼으로 개발?

### 4️⃣ 결론적으로, 넥토리얼 과정에서의 멘토님과 CODEX는 본질적으로 같다고 생각한다.

<div style="text-align: center;">
  <img src="./captures/ai like mentor.png" width="600">
</div>
