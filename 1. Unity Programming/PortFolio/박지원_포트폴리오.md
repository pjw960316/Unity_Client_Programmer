...
# 🧮 [두 번째 해결과정] <br> AI 시대에 다양한 스펙트럼으로 개발?
...
### 1️⃣ 메모를 많이 하는 것 → 다시 읽히는 기록을 만드는 것으로 바뀌었다. (Notion 내용을 적자)
...
### 2️⃣ 게임에서 랭커?를 달성한 과정에서 깨달은 것. -> 개발도 같은 방식으로 하면 잘하지 않을까?
...
### 3️⃣ 나만의 디자인 패턴을 많이 만들어서 개발을 한다.
