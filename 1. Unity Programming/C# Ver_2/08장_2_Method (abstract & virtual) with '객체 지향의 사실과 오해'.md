...
#### :three::fire: BindEvent()도 public으로 만들고 외부에서 Initialize() 호출 이후에 <br> BindEvent()를 호출하면 1번과 2번의 장점을 모두 이용한다. <br> :fire: 그러나 BindEvent()를 public으로 빼는 건 캡슐화를 깨기에 좀 그렇다.
