...
- **우리가 사용하는 ValueTuple**
<img src="../capture/20260410_4.png" width="600" height="400" />

<br>
    
- **과거의 레거시인 Tuple**
<img src="../capture/20260410_5.png" width="600" height="400" />
...
## :bangbang: List의 Generic이 Tuple일 때, Tuple의 원소에 직접 접근해서 수정 할 수 없다. <br> Tuple 자체를 교체해야 한다.
  - 컴파일 에러가 발생한다.
