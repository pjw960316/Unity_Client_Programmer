...
#### :four: StringBuilder는 IEnumerable<T>(및 IEnumerable)를 구현하지 않기 때문에 <br> 직접적인 foreach나 LINQ 사용이 불가능하다. <br> :fire: 반면에, String은 IEnumerable<char>를 구현하고 있으므로 <br> foreach와 LINQ 사용이 가능하다.**
