...
## :fire: Animation Clip만 다르고 로직은 같을 때 <br> Animation Override Controller를 사용한다. <br> 그러나 변경이 자유롭지 않기 때문에 신중하게 사용한다.
...
- 잘 만들어 놓은 Animation Controller를 넣어주면 transition만 이식된다. 
- AudioClip은 override 하면 된다.
